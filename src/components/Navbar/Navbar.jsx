...
const Navbar = () => {
    return(
      <nav className={s.nav}>
        ...
        <div><NavLink to='/dialog' className = { navData => navData.isActive ? s.active : s.item }>Messages</NavLink></div>
        <div><NavLink to='/news' className = { navData => navData.isActive ? s.active : s.item }>News</NavLink></div>
        <div><NavLink to='/friends' className = { navData => navData.isActive ? s.active : s.item }>Find Friends</NavLink></div>
